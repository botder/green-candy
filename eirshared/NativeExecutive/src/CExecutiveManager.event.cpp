...
static _GCCCOMPAT_CONSTINIT_FUNCDECL_ void (*_event_constructor)( void *mem, bool shouldWait ) = nullptr;
static _GCCCOMPAT_CONSTINIT_FUNCDECL_ void (*_event_destructor)( void *mem ) noexcept = nullptr;
static _GCCCOMPAT_CONSTINIT_FUNCDECL_ void (*_event_set)( void *mem, bool shouldWait ) noexcept = nullptr;
static _GCCCOMPAT_CONSTINIT_FUNCDECL_ void (*_event_wait)( void *mem ) noexcept = nullptr;
static _GCCCOMPAT_CONSTINIT_FUNCDECL_ bool (*_event_wait_timed)( void *mem, unsigned int msTimeout ) noexcept = nullptr;
