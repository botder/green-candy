...
concept NothrowCompareCompatibleComparator =
    ( CompareCompatibleRegularComparator <comparatorType, LT, RT> && NothrowCompareCompatibleRegularComparator <comparatorType, LT, RT> ) ||
    ( CompareCompatibleInverseComparator <comparatorType, LT, RT> && NothrowCompareCompatibleInverseComparator <comparatorType, LT, RT> );
