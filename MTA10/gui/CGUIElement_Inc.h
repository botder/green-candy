...
abiString GetProperty ( const char *szProperty )            { return CGUIElement_Impl::GetProperty ( szProperty ); };
...
abiString GetFont ( void )                                  { return CGUIElement_Impl::GetFont (); };
...
abiString GetText ( void )                                  { return CGUIElement_Impl::GetText (); };
