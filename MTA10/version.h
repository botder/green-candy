...
#define _CLIENT_NET_MODULE_VERSION      0x040       // (0x000 - 0xfff) Lvl9 wizards only
#define _NETCODE_VERSION                0x1CC       // (0x000 - 0xfff) Increment when net messages change (pre-release)
#define MTA_DM_BITSTREAM_VERSION        0x022       // (0x000 - 0xfff) Increment when net messages change (post-release). (Changing will also require additional backward compatibility code).
