...
bool CRegisteredCommands::AddCommand ( CLuaMain* pLuaMain, const char* szKey, const LuaFunctionRef& iLuaFunction, bool bCaseSensitive )
{
    assert ( pLuaMain );
    assert ( szKey );
...
void CRegisteredCommands::CallCommandHandler ( CLuaMain* pLuaMain, const LuaFunctionRef& iLuaFunction, const char* szKey, const char* szArguments )
{
    assert ( pLuaMain );
    assert ( szKey );
