...
public:
    ...
    virtual CShaderItem*        CreateShader                        ( const SString& strFullFilePath, const SString& strRootPath, abiString& strOutStatus, float fPriority, float fMaxDistance, bool bDebug ) = 0;
    virtual CShaderItem*        CloneShader                         ( CShaderItem *shader ) = 0;
