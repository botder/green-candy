...
const GUID GUID_XAxis_local = { 0xA36D02E0,0xC9F3,0x11CF,0xBF,0xC7,0x44,0x45,0x53,0x54,0x00,0x00 };
const GUID GUID_YAxis_local = { 0xA36D02E1,0xC9F3,0x11CF,0xBF,0xC7,0x44,0x45,0x53,0x54,0x00,0x00 };
const GUID GUID_ZAxis_local = { 0xA36D02E2,0xC9F3,0x11CF,0xBF,0xC7,0x44,0x45,0x53,0x54,0x00,0x00 };
const GUID GUID_RxAxis_local = { 0xA36D02F4,0xC9F3,0x11CF,0xBF,0xC7,0x44,0x45,0x53,0x54,0x00,0x00 };
const GUID GUID_RyAxis_local = { 0xA36D02F5,0xC9F3,0x11CF,0xBF,0xC7,0x44,0x45,0x53,0x54,0x00,0x00 };
const GUID GUID_RzAxis_local = { 0xA36D02E3,0xC9F3,0x11CF,0xBF,0xC7,0x44,0x45,0x53,0x54,0x00,0x00 };
const GUID GUID_Slider_local = { 0xA36D02E4,0xC9F3,0x11CF,0xBF,0xC7,0x44,0x45,0x53,0x54,0x00,0x00 };

const GUID GUID_Button_local = { 0xA36D02F0,0xC9F3,0x11CF,0xBF,0xC7,0x44,0x45,0x53,0x54,0x00,0x00 };
const GUID GUID_Key_local = { 0x55728220,0xD33C,0x11CF,0xBF,0xC7,0x44,0x45,0x53,0x54,0x00,0x00 };

const GUID GUID_POV_local = { 0xA36D02F2,0xC9F3,0x11CF,0xBF,0xC7,0x44,0x45,0x53,0x54,0x00,0x00 };

const GUID GUID_Unknown_local = { 0xA36D02F3,0xC9F3,0x11CF,0xBF,0xC7,0x44,0x45,0x53,0x54,0x00,0x00 };

// Some other GUIDs.
const GUID GUID_Xbox360Controller = { 0x028E045E,0x0000,0x0000,0x00,0x00,0x50,0x49,0x44,0x56,0x49,0x44 };
...
extern const GUID GUID_Xbox360Controller;
...
BOOL CJoystickManager::DoEnumObjectsCallback ( const DIDEVICEOBJECTINSTANCE* pdidoi )
{
    ...
    if ( pdidoi->dwType & DIDFT_AXIS )
    {
        ...
        if ( pdidoi->guidType == GUID_XAxis_local )    axisIndex = 0;
        if ( pdidoi->guidType == GUID_YAxis_local )    axisIndex = 1;
        if ( pdidoi->guidType == GUID_ZAxis_local )    axisIndex = 2;
        if ( pdidoi->guidType == GUID_RxAxis_local )   axisIndex = 3;
        if ( pdidoi->guidType == GUID_RyAxis_local )   axisIndex = 4;
        if ( pdidoi->guidType == GUID_RzAxis_local )   axisIndex = 5;
        if ( pdidoi->guidType == GUID_Slider_local )   axisIndex = 6;
