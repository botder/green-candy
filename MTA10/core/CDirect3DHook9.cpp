...
bool CDirect3DHook9::ApplyHook ( )
{
    ...
    g_hookingLib.Hook( &m_API_Direct3DCreate9_hookid, (LPVOID*)&m_pfnDirect3DCreate9, (LPVOID)GetProcAddress( GetModuleHandleW( L"D3D9.DLL" ), "Direct3DCreate9" ), (LPVOID)API_Direct3DCreate9 );
...
bool CDirect3DHook9::RemoveHook ( )
{
    ...
    if ( m_pfnDirect3DCreate9 != NULL )
    {
        ...
        g_hookingLib.Unhook( m_API_Direct3DCreate9_hookid );
