...
bool CPixelsManager::GetVolumePixels ( IDirect3DVolume9* pD3DSurface, CPixels& outPixels, const RECT* pRect, uint uiSlice )
{
    ...
    POINT SurfSize = { (LONG)SurfDesc.Width, (LONG)SurfDesc.Height };
    RECT SurfRect = { 0, 0, (LONG)SurfDesc.Width, (LONG)SurfDesc.Height };
    if ( pRect )
        SurfRect = *pRect;
    ...
    POINT PixelsSize = { (LONG)uiPixelsWidth, (LONG)uiPixelsHeight };
    RECT PixelsRect = { 0, 0, (LONG)uiPixelsWidth, (LONG)uiPixelsHeight };
