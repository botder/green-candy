...
static void __cdecl OpenStandardArchives( void )
{
    ...
    // Process GTA3.IMG
    *VAR_GTA3IMGIndex = OpenImgFile( "MODELS\\GTA3.IMG", true );

    // Process GTA_INT.IMG
    *VAR_GTA_INTIndex = OpenImgFile( "MODELS\\GTA_INT.IMG", true );
}
...
/*=========================================================
    ...
    Purpose:
        Initializes this .IMG resource data container. It is a 'directory entry' for
        in any .IMG container that has been loaded into the engine.
    Binary offsets:
...
=========================================================*/
unsigned int __cdecl OpenImgFile( const char *path, bool isNotPlayerImg )
{
    unsigned int idx;
