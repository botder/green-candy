...
void DumpHandlingData ( tHandlingDataSA* pData )
{
    ...
    CFile *file = core->GetMTARoot()->Open( "handling_dump.txt", "a+" );
    {
        ...
        output << "    m_OriginalHandlingData [" << iCounter << "].iVehicleID = " << iCounter << "\n";
        output << "    m_OriginalHandlingData [" << iCounter << "].fTurnMass = " << pData->fTurnMass << ";\n";
        output << "    m_OriginalHandlingData [" << iCounter << "].fDragCoeff = " << pData->fDragCoeff << ";\n";
        output << "    m_OriginalHandlingData [" << iCounter << "].vecCenterOfMass = CVector ( " << pData->vecCenterOfMass.fX << ", " << pData->vecCenterOfMass.fY << ", " << pData->vecCenterOfMass.fZ << " );\n";
        output << "    m_OriginalHandlingData [" << iCounter << "].uiPercentSubmerged = " << pData->uiPercentSubmerged << ";\n";
        output << "    m_OriginalHandlingData [" << iCounter << "].fTractionMultiplier = " << pData->fTractionMultiplier << ";\n";
