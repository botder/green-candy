...
namespace CEGUI
{
    class CETinyXMLDocument : public TiXmlDocument
    {
    public:
        CETinyXMLDocument(XMLHandler& handler, const String& filename, const String& schemaName, const String& resourceGroup);
        ~CETinyXMLDocument()
        {}
    protected:
    ...
    CETinyXMLDocument::CETinyXMLDocument(XMLHandler& handler, const String& filename, const String& schemaName, const String& resourceGroup)
    {
        d_handler = &handler;
    ...
    void CETinyXMLDocument::processElement(const TiXmlElement* element)
    {
    ...
    {
        CETinyXMLDocument doc(handler, filename, schemaName, resourceGroup);
    }
