...
#ifndef _SHAREDUTIL_MISC_
#define _SHAREDUTIL_MISC_
...
namespace SharedUtil
{
    ...
    inline void     OutputDebugLine( const std::string& szMessage )         { OutputDebugLine( szMessage.c_str() ); }
#else
